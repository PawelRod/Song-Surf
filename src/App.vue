...
<simplebar :class="{'simplebar-overflow': hideSimplebar}" data-simplebar-auto-hide="true">
    <div id="app">
        ...
        <form class="form" method="get" v-on:submit.prevent>
            <input class="form__input" :class="{ 'form__input--margin': inputIsFilled }" v-model="search" @input="loadingThenShowItems" type="search" aria-label="Enter search text" placeholder="find artists, titles, albums and more..." spellcheck="false" />
        ...
        <transition name="fade">
            <player v-show="showComp" :token="token" :songPath="songPath" @exit="exitComp" @minimize="minimizeComp">
            </player>
        </transition>
        <transition name="fade">
...
header.header--thin,
img.header__decoration-left--thin,
img.header__logo--thin,
div.header__decoration-right--thin {
